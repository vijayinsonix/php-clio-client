 ...
 */
class Clio extends LazyExtractor
{

    /**
     * Request contants
     */
    const REQUEST_PROFILE = '/api/v2/users/who_am_i';
    ...
    {
        return true; // clio users who have access to Open Graph and OAuth always have a verified email
    }
